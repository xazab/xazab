...
BASE_SCRIPTS= [
    ...
    'feature_block.py', # NOTE: needs xazab_hash to pass
    ...
    'feature_llmq_signing.py', # NOTE: needs xazab_hash to pass
    'feature_llmq_signing.py --spork21', # NOTE: needs xazab_hash to pass
    'feature_llmq_chainlocks.py', # NOTE: needs xazab_hash to pass
    'feature_llmq_connections.py', # NOTE: needs xazab_hash to pass
    'feature_llmq_simplepose.py', # NOTE: needs xazab_hash to pass
    'feature_llmq_is_cl_conflicts.py', # NOTE: needs xazab_hash to pass
    'feature_llmq_is_retroactive.py', # NOTE: needs xazab_hash to pass
    'feature_llmq_dkgerrors.py', # NOTE: needs xazab_hash to pass
    'feature_dip4_coinbasemerkleroots.py', # NOTE: needs xazab_hash to pass
    # vv Tests less than 60s vv
    'p2p_sendheaders.py', # NOTE: needs xazab_hash to pass
