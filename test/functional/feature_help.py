...
"""Verify that starting xazabd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start xazabd with -h for help text")
        ...
        self.log.info("Start xazabd with -version for version information")
