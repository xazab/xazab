...
//! Interface for the src/evo part of a xazab node (xazabd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a xazab node (xazabd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a xazab node (xazabd process).
...
//! Top-level interface for a xazab node (xazabd process).
class Node
{
public:
    virtual ~Node() {}
