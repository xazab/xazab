...
/** Utility functions used by the Xazab Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "xazab:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load xazab specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a xazab specific theme is activated (light/dark).*/
