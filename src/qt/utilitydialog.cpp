    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  xazab-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Xazab in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 XAZAB, 0.01 XAZAB, 0.1 XAZAB, 1 XAZAB and 10 XAZAB -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a style=\"%1\" href=\"https://docs.xazab.xyz/en/stable/wallets/xazabcore/privatesend-instantsend.html\">PrivateSend documentation</a>."
