...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Xazab features */
    { "xazab",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "xazab",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "xazab",               "gobject",                &gobject,                true,  {} },
    { "xazab",               "voteraw",                &voteraw,                true,  {} },
