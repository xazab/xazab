...
UniValue getinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total xazab balance of the wallet\n"
...
#ifdef ENABLE_WALLET
        // Case 1: Xazab address and we have full public key:
...
UniValue createmultisig(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 2)
    {
        std::string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are xazab addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) xazab address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "util",               "setalgo",                &setalgo,                true,  {"algo"}},
    ...
    /* Xazab features */
    { "xazab",               "mnsync",                 &mnsync,                 true,  {} },
    { "xazab",               "spork",                  &spork,                  true,  {"value"} },
