...
UniValue getblockchaininfo(const JSONRPCRequest& request)
{
    ...
    BIP9SoftForkDescPushBack(bip9_softforks, "Reward Reallocation", consensusParams, Consensus::DEPLOYMENT_REALLOC);
    BIP9SoftForkDescPushBack(bip9_softforks, "v17", consensusParams, Consensus::DEPLOYMENT_V17);
