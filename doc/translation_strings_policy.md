...
This document provides guidelines for internationalization of the Xazab Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `xazab_en.ts` remains unchanged.
