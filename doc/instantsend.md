...
This mechanism has been integrated into Bitcore-Node-Xazab which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/xazab/insight-api-xazab#web-socket-api](https://github.com/xazab/insight-api-xazab#web-socket-api)
* API: [https://github.com/xazab/insight-api-xazab#instantsend-transactions](https://github.com/xazab/insight-api-xazab#instantsend-transactions)
